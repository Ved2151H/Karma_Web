...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PROCESSING', 'DISPATCHED', 'SHIPPED', 'DELIVERED', 'CANCELLED');
...
CREATE TABLE "products" (
    ...
    "discount" INTEGER,
    "badge" TEXT,
    "brand" TEXT NOT NULL DEFAULT 'KARAM',
    "industry" TEXT,
    "material" TEXT,
    "resistanceType" TEXT,
    "lensType" TEXT,
...
CREATE TABLE "store_settings" (
    ...
    "storeName" TEXT NOT NULL DEFAULT 'KARAM Safety Online Store',
    "email" TEXT NOT NULL DEFAULT 'support@karam.in',
    "phone" TEXT NOT NULL DEFAULT '+91 120 4734400',
    "address" TEXT NOT NULL DEFAULT 'D-95, Sector 63, Noida, Uttar Pradesh 201301, India',
    "updatedAt" TIMESTAMP(3) NOT NULL,
