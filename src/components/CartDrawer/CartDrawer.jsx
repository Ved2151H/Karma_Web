            ...
            {cartItems.length > 0 && (
              <div className="p-5 border-t border-[#ececec] bg-white select-none">
                ...
                <button
                  ...
                  className="w-full h-[56px] bg-[#E31E24] hover:bg-[#c91a20] text-white text-sm font-bold uppercase tracking-widest rounded-none shadow-sm cursor-pointer transition-colors flex items-center justify-center"
                >
                  PROCEED TO CHECKOUT
                </button>
              </div>
