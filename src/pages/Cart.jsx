        ...
        {cartItems.length === 0 ? (
          ...
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="w-full lg:w-[380px] bg-neutral-50 border border-neutral-100 rounded-2xl p-6 h-fit">
              ...
              <button className="w-full bg-[#E31E24] text-white hover:bg-red-700 py-3.5 rounded-xl text-xs font-bold uppercase tracking-wider shadow-lg hover:shadow-brand-red/10 cursor-pointer transition-colors">
                Proceed To Checkout
              </button>
            </div>
          </div>
