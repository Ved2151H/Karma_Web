...
import { Search, Eye, ClipboardList, CheckCircle2, Truck, XCircle, AlertCircle } from 'lucide-react';

function OrdersManagement() {
  const [orders, setOrders] = useState([
    { id: 'KRM-8402', customer: 'Rajesh Sharma', email: 'rajesh@gmail.com', amount: 14500, status: 'Processing', date: '2026-06-06' },
    { id: 'KRM-8399', customer: 'Priya Patel', email: 'priya.patel@yahoo.com', amount: 2350, status: 'Completed', date: '2026-06-05' },
    { id: 'KRM-8395', customer: 'Amit Kumar', email: 'amit.kumar@outlook.com', amount: 12800, status: 'Shipped', date: '2026-06-04' },
    { id: 'KRM-8380', customer: 'Sneha Reddy', email: 'sneha@reddy.co', amount: 450, status: 'Cancelled', date: '2026-06-02' },
    { id: 'KRM-8371', customer: 'Rohan Gupta', email: 'rohan.gupta@gmail.com', amount: 8900, status: 'Completed', date: '2026-05-30' },
  ]);
                ...
                filteredOrders.map((ord) => {
                  ...
                  return (
                    <tr key={ord.id} className="hover:bg-gray-850/20 transition-colors">
                      ...
                      {/* Action dropdown or quick action */}
